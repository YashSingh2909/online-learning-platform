        ...
        <div className="dashboard-header-card">
          <div className="dashboard-header-content">
            ...
            <div className="dashboard-role">
              ...
              <p className="dashboard-role-value">{user?.role}</p>
            </div>
          </div>
        </div>
        ...
        <div className="dashboard-main-grid">
              ...
              {loading ? (
                ...
                <div className="dashboard-grid">
                  {enrollments.slice(0, 4).map((enr) => (
                    <Link key={enr._id} to={`/course/${enr.course?._id}`} className="course-card-alt">
                      <div className="course-card-header">
                        <div>
                          <h3 className="course-card-title">{enr.course?.title || 'Course'}</h3>
                          <p className="course-card-meta">{enr.status}</p>
                        </div>
                      </div>
                ...
                <div className="dashboard-empty">
                  <h3 className="dashboard-empty-title">No courses yet</h3>
              ...
              <div className="dashboard-section-header">
                ...
                {user?.role === 'instructor' && (
                  <button
                    ...
                    type="button"
                    onClick={() => {
                      // Basic instructor flow: open course creation form
                      // (until a dedicated instructor page is built)
              ...
              {loading ? (
                ...
                <div className="courses-grid-mini">
                  {courses.slice(0, 6).map((course) => (
                    <Link key={course._id} to={`/course/${course._id}`} className="course-card-mini">
                ...
                <div className="dashboard-empty">
                  <p className="dashboard-empty-text">No courses available.</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="dashboard-right">
            ...
            <div className="sidebar-card">
              <p className="sidebar-label">Current Plan</p>
              <h3 className="sidebar-title">Essential</h3>
              <p className="sidebar-text">A flexible learning hub for students and instructors.</p>
            </div>
